      ...
      <div className="flex-1 flex flex-col overflow-y-auto p-10">
        <div className="flex justify-center py-7">
          <div className="w-full max-w-[600px] md:max-w-[800px]">
            <div className="cursor-pointer bg-white bg-opacity-30 border-dotted border-2 border-black md:w-[600px] md:h-[100px] h-[60px] flex justify-center items-center hover:opacity-60 hover:border-4 relative rounded-2xl m-auto" onClick={() => openEditor()}>
